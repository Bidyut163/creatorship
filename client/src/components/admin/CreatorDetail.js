...
import { getCreatorProfileById } from '../../actions/profile';
...
const CreatorDetail = ({
    ...
    useEffect(() => {
        ...
        getCreatorProfileById(creatorId);
    }, []);
        ...
        <div className="content-wrapper">
                        ...
                        <div className="card-body">
                            <div className="d-flex flex-column align-items-center text-center">
                                ...
                                <div className="mt-3">
                                    ...
                                    <p className="text-muted mb-1">Creator</p>
            ...
            <div className="row">
                <div className="col-xl-9 grid-margin-lg-0 grid-margin stretch-card">
                    <div className="card">
                        <div className="card-body">
                            <h4 className="card-title">About Creator</h4>
                            <div className="mt-3">
                                <h5 className="card-title">About yourself</h5>
                                <p className="mt-3">{profile.selfDesc}</p>
                            </div>
                            <div className="mt-3">
                                <h5 className="card-title">
                                    How do you help brands
                                </h5>
                                <p className="mt-3">{profile.helpDesc}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
export default connect(mapStateToProps, { getCreatorProfileById })(
    CreatorDetail
);
